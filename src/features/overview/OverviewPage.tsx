...
export default function OverviewPage() {
  ...
  const findings = deriveReadiness({ capabilities: capabilities.data, identities: identities.data, buckets: buckets.data, backends: backends.data, keys: keys.data, roles: roles.data?.items, now: Date.now() })
