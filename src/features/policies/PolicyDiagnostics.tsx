...
export default function PolicyDiagnostics() {
  ...
  return <div className="policy-diagnostics">
    <IdentitySelectorPagination page={identitySelector.page} pending={identityPage.isFetching} canPrevious={identitySelector.canPrevious} canNext={identitySelector.canNext} previous={() => { setCredentialId(''); identitySelector.previous() }} next={() => { setCredentialId(''); identitySelector.next() }} />
