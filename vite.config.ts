...
export default defineConfig({
  ...
  server: {
    proxy: {
      '^/admin/ui/(backends(?:/|$|\\?)|virtual-buckets(?:/|$|\\?)|mapping-backends/|roles(?:/|$|\\?)|role-policies(?:$|\\?)|identities(?:/|$|\\?)|identity-pages(?:/|$|\\?)|policies(?:/|$|\\?)|bucket-policies(?:/|$|\\?))': { target: 'http://127.0.0.1:8080', changeOrigin: false, bypass: request => policyDocumentBypass(request) },
